...
#define LCD_W 240
#define LCD_H 320
#define LCD_DC GPIOG,GPIO_Pin_15
...
void LCD_SPI_Init()
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_AFIO | RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOG, ENABLE);
...
//#define DC_0() GPIO_ResetBits(GPIOB,GPIO_Pin_4)
//#define DC_1() GPIO_SetBits(GPIOB,GPIO_Pin_4)
